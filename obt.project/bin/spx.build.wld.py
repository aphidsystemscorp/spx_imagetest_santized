...
argparser = argparse.ArgumentParser(description='Build wld project')  
argparser.add_argument('--clean', action='store_true', help='Clean build directory')
args = argparser.parse_args()
clean = args.clean

wld_src = spx_path.root/"submodules"/"wld"
wld_dst = obt_path.builds()/"aarch64-wld"
wld_bld = wld_dst/".build"
...
if clean:
  pathtools.rmdir(wld_bld,force=True)

pathtools.mkdir(wld_bld,parents=True)
pathtools.chdir(wld_dst)
